...
class IllegalCharError(Error):
  def __init__(self, pos_start, pos_end, details):
    super().__init__(pos_start, pos_end, 'Удав Не Дає Пройти', details)

class ExpectedCharError(Error):
  def __init__(self, pos_start, pos_end, details):
    super().__init__(pos_start, pos_end, 'Удав З\'їв Потрібний Символ', details)

class InvalidSyntaxError(Error):
  def __init__(self, pos_start, pos_end, details=''):
    super().__init__(pos_start, pos_end, 'Удав Заплутав Код', details)

class RTError(Error):
  def __init__(self, pos_start, pos_end, details, context):
    super().__init__(pos_start, pos_end, 'Удав Схопив Програму За Горло', details)
  ...
  def generate_traceback(self):
    ...
    return 'Удав Гризе Код (останній виклик в кінці):\n' + result
