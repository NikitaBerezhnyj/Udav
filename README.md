...
число_вводу = ціле_число ( ввід () )

# Записується ціле число
дріб_вводу = дробове_число ( ввід ()) )
```
...
# Умова якщо-інакше_якщо-інакше
якщо а < 5 : 
    друк ("<5") 
інакше_якщо а > 5 і а < 8 : 
    друк ("<5 and >8") 
інакше :
    друк (">8")
```
...
***Оголошення циклу for (для_будь_якого)***

``` python
# Приклад циклу for (для_будь_якого)
для_будь_якого л в границях (10) :
    друк ("Привіт, Світ!")
```
...
# Приклад функції
функція Привіт_світ() :
	рази = ціле_число ( ввід ("Введіть кількість повторів: ") )
	друк (рази)
	для_будь_якого i в range(рази) :
		друк ("Привіт, Світ!")
```
...
функція Гра(кількість_спроб, випадкове_число) :
    для_будь_якого спроба в границях ( кількість_спроб ) :
        друк ("Введіть будь ласка число від 1 до 10:")
        користувацьке_число = ціле_число ( ввід ("Введіть число: ") )
        якщо користувацьке_число < випадкове_число :
            друк ("Переможне число більше")
        інакше_якщо користувацьке_число > випадкове_число :
...
кількість_спроб = ціле_число ( ввід ("Скільки ви хочете спроб:"))
